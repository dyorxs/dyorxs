...
const CakeStats = () => {
  ...
  return (
    <StyledCakeStats>
      <CardBody>
        <Text
          style={{ fontSize: '18px', lineHeight: '24px', letterSpacing: '0.3px', color: '#131313', fontWeight: 'bold' }}
        >
        ...
        <Row>
          ...
          <CardValue fontSize='16px' color='#131313' bold value={totalSupply} />
        </Row>
        <Row>
          <Text fontSize='16px' color='#8990A5'>
            {TranslateString(538, 'Total ALM Burned')}
          </Text>
          <CardValue fontSize='16px' color='#131313' value={getBalanceNumber(burnedBalance)} />
        </Row>
        <Row>
          <Text fontSize='16px' color='#8990A5'>
            {TranslateString(540, 'New ALM/block')}
          </Text>
          <CardValue fontSize='16px' color='#131313' value={almPerBlock} />
        </Row>
      </CardBody>
    </StyledCakeStats>
  )
