...
const Menu: FC<{ loginBlockVisible?: boolean }> = ({ loginBlockVisible, ...props }) => {
  ...
  const links: MenuEntry[] = [
    ...
    { label: 'Token Pre-Sale (Coming Soon)', icon: 'PrivateRoundIcon', href: '#' },
    // {
    //   label: 'Analytics',
    //   icon: 'InfoIcon',
    //   items: [
    ...
    // },
    {
      ...
      items: [
       // { label: 'Audits', href: ROUTES.audits },
        ...
        { label: t('mainMenu.github'), href: 'https://github.com/DYOR-Audit' },
        // { label: 'Docs', href: 'https://docs.pancakeswap.finance' },
        { label: 'Docs', href: 'https://dyor-audit.gitbook.io/dyor-audit/' },
        { label: t('mainMenu.blog'), href: 'https://dyoraudit.medium.com/' },
      ],
    },
